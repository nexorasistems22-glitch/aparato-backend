...
exports.dashboardRouter.get('/', async (req, res) => {
    ...
    const [todayAppointments, monthAppointments, lastMonthAppointments, monthRevenue, lastMonthRevenue, totalClients, newClientsMonth, topProfessionals, topServices, recentAppointments, upcomingToday,] = await Promise.all([
        // Today appointments
        ...
        // Total clients
        prisma_1.prisma.client.count({ where: { tenantId, isActive: true } }),
        ...
        // Top services
        prisma_1.prisma.appointmentService.groupBy({
            by: ['serviceId'],
            where: {
                appointment: {
                    tenantId,
